...
def train_anfis_cat(model, train_loader, val_loader, optimizer, EPOCHS, targets):
    print(device)
    ...
    for e in tqdm(range(1, EPOCHS + 1)):
        ...
        with torch.no_grad():
            val_epoch_loss = 0
            val_epoch_acc = 0
            model.fit_coeff(X_train_batch.float(), make_one_hot(y_train_batch.float(), num_categories=targets))
    ...
    return best_model, loss_stats['val'], best_epoch
